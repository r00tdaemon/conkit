	...
	local bars_settings={
		{
			...
			max=100,
			alarm=80,
			bg_colour={0x001623,0.50},
			fg_colour={0x064f7c,1.00},
			alarm_colour={0x660000,1.00},
			x=50,y=200,
			blocks=10,
			height=10,width=50,
			angle=0,
			...
			smooth=true,
			--led_effect="a",
			--fg_led={0x008fe2,0.50},
			--bg_led={0x000000,0.30},
			cap="b",
			--skew_x=0,
            space=6,
			mid_colour={{0.45,0x426c87,0.60}},
			draw_me=false		
		},
		{
			name="cpu",
